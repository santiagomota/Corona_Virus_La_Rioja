...
if (!_tb_dis) {
    var pm_ppy = "vocentoregionales-network";
    ...
    var _pmpmk = pm_ppy + '/pmk-202003261.7.js';
    var _pmasync = true;
...
var _tb_vpx = [{
    'xpath': '//div[contains(@class, "video-player")]//div[contains(@class, "video-js")]',
    'attr': 'div'
}, 
{
    'xpath': '//div[contains(@class,"vjs")]//iframe',
    'attr': 'iframe'
}
...
if (window.location.href.indexOf('https://blogs.elcorreo.com') > -1 || window.location.href.indexOf('https://blogs.ideal.es') > -1) {
    var _pm_ecd = {
        'at': '(//div[contains(@class,"blog-author")]//a[contains(@class,"blog-author")])[1]',
        'sx': '//h1[@class="voc-region"]/a',
         'atd': [" y "]
